...
public class Form_SanPham extends javax.swing.JPanel {
    ...
    private boolean isFormSPEmpty() {
        return txtMaSanPham3.getText().trim().isEmpty() || txtTenSanPham3.getText().trim().isEmpty();
    }
    ...
    private boolean checkTrungMaKH(String maSP) {
    ...
    private javax.swing.JRadioButton rdoHoatDong2;
    ...
    private javax.swing.JRadioButton rdoNgungHoatDong2;
